<div class="form-group">
   ...
   @if ($mode=='edit')
   <input type="text" maxlength=256 size=45 name="formation_name" id="formation_name" required value="{{$formationName}}">
   ...
   <input type="text" list="formations" maxlength=256 size=45  name="formation_name" id="formation_name">
